...
await window.EmerusZoho.sendLead({
  ...
  lists: ['3zd0e1436524a9384bd0a0c25503f37f8de5c927d6a56bdbc3389723fea607135'], // optional: Zoho Campaigns list keys / IDs
...
- `extraPayload.lists`: optional Zoho Campaigns list keys / IDs
...
- `lists` payload is processed backend after lead/contact create via Zoho Campaigns `listsubscribe` API using list keys/IDs.
- You can configure auto-routing in plugin options: general list (all forms), newsletter list, gated list, and interes-based category lists.
